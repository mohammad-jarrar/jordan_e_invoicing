...
def send_invoice(invoice_name):
    ...
    try:
        ...
        invoice_data = {
            ...
            "additional_doc_id": "12345",  # Example additional document ID
            "additional_doc_type": "Contract",  # Example document type
        ...
        if not qr_code or not qr_code.startswith("QR-"):
            frappe.throw("Invalid QR code returned by the API.")
